...
public class SendToPubService {
    ...
    private void insert(String noticeId) {
        ...
        while (bidCode.length() < 20) {
            bidCode += ("0");
        }
        String packageNumber = bidCode + "000";
        ...
        datas.put("tenderProjectCode", bidCode);
    ...
    public void resendFromNotice() {
        String noticeId = "04778c874e0d4915b88c98003ea235b0";
        insert(noticeId);
    }
