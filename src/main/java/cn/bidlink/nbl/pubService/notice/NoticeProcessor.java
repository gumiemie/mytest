...
import cn.bidlink.nbl.pubService.model.*;
...
import static cn.bidlink.nbl.pubService.model.Utils.*;
...
public class NoticeProcessor {
    ...
    @Test
    public void execute() {
        String noticeId = "6c87489f60b4447288a43e3bd400ff79";
        insertLogByNoticeId(noticeId);
    }
    ...
    private void insertLogByNoticeId(String noticeId) {
        ...
        Map<String, String> numbers = processNumber(noticeModel.getBidCode());
        //招标项目编号
