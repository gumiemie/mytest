...
public class DrawSealUtil {
    ...
    public static String drawCircularSeal(String filePath,String fontName,String sealName, String name, String numCode,String singFontName,String sign){
        ...
        //画五角星
        drawFiveStar(gs, DIAMETER/2+6, DIAMETER/2+6, DIAMETER/5-4);        
        //画说明数据
        ...
        //画下方的环形数字
        drawRealNumber(gs,usedFontName, numCode, DIAMETER/2+6, DIAMETER/2+6, DIAMETER/2);
        //签名
    ...
    private static void drawSealMessage(Graphics2D gs,String fontName, String message, int x, int y){
        if (StringUtils.isNotBlank(message)) {
            ...
            String[] messages = new String[sourceMessages.length];
            System.arraycopy(sourceMessages, 0, messages, 0, sourceMessages.length);
            // 输入的字数
     ...
     * @return
     */
    private Font createFont(String filePath,Integer style,float size){
		...
		try
		{
			...
			//drawText("测试","楷体");
			 /* //Loading an existing document
		      File file = new File("D:/pdfBox.pdf");
		      ...
		      PDImageXObject pdImage = PDImageXObject.createFromFile("D:/2018/seal.png",doc);
		      
		      PDPageContentStream contents = new PDPageContentStream(doc, page);

		      //Drawing the image in the PDF document
		      contents.drawImage(pdImage,400,40,200, 200);
		      
		      //Closing the PDPageContentStream object
		      contents.close();        

		      //Saving the document
		      doc.save("d:/2018/pdfboxSeal.pdf");
